...
describe('create email domain validation', () => {
  it('should return errors if no fields specified', () => {
    const newDomain = { domainName: '', domainDescription: 'Domain Description 1' }
    expect(validateCreateDomain(newDomain)).toEqual([{ href: '#domainName', text: 'Enter a domain name' }])
  })

  it('should disallow short email domain name', () => {
  ...
  it('should disallow too long email domain name', () => {
  ...
  it('should return an error if domain description is not specified', () => {
  ...
  it('should disallow too short domain description field', () => {
  ...
  it('should disallow domain description that is too long', () => {
