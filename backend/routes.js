...
const manageExternalUserSearchRouter = require('./routes/manageExternalUserSearchRouter')
...
const configureRoutes = ({ oauthApi, prisonApi }) => {
  ...
  router.use('/search-external-users', manageExternalUserSearchRouter({ oauthApi, logError }))
